...
import shihab.mypro.com.gridviewex.questionset.Bangla;

import static android.R.color.holo_red_light;

public class BanglaPreparation extends AppCompatActivity {

    Button option1,option2,option3,option4;
    TextView score, question,showAns;

    private Bangla questionSet = new Bangla();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_bangla_preparation);
        getSupportActionBar().setTitle("Bangla Preparation");
