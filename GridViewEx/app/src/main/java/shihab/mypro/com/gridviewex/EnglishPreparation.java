...
import shihab.mypro.com.gridviewex.questionset.English;

public class EnglishPreparation extends AppCompatActivity {

    Button option1,option2,option3,option4;
    TextView score, question,showAns;

    private English questionSet = new English();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_english_preparation);
        getSupportActionBar().setTitle("English Preparation");
