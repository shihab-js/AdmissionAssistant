...
import shihab.mypro.com.gridviewex.questionset.GeneralKnowledge;

public class GeneralKnowledgePreparation extends AppCompatActivity {

    Button option1,option2,option3,option4;
    TextView score, question,showAns;

    private GeneralKnowledge questionSet = new GeneralKnowledge();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_general_knowledge_preparation);
        getSupportActionBar().setTitle("General Knowledge Preparetion");
