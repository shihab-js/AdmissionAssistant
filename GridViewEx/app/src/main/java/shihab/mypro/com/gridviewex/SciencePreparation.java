...
import shihab.mypro.com.gridviewex.questionset.Science;

public class SciencePreparation extends AppCompatActivity {

    Button option1,option2,option3,option4;
    TextView score, question,showAns;

    private Science questionSet = new Science();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_science_preparation);
        getSupportActionBar().setTitle("Science Preparation");
